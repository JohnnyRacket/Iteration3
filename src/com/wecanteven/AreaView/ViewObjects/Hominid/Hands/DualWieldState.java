 ...
 */
public class DualWieldState extends HandState {
    ...
    public DualWieldState(Direction direction,MicroPositionableViewObject leftHand, MicroPositionableViewObject rightHand, Entity entity) {
